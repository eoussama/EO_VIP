...
#include <foreach>					// by Y_Less and Kar 		> 	github.com/karimcambridge/SAMP-foreach
...
#define DIALOG_TOYSINDEX			5005
#define DIALOG_PRESETGUNLIST		5006
#define DIALOG_GUNLISTMELEE			5007
#define DIALOG_GUNLISTPISTOL		5008
#define DIALOG_GUNLISTSHOTGUN		5009
#define DIALOG_GUNLISTSUBMACHINE	5010
#define DIALOG_GUNLISTASSAULT		5011
#define DIALOG_GUNLISTRIFLE			5012
#define DIALOG_VIPGPPRESETDELETE	5013
...
public OnFilterScriptInit()
{
	...
	if(mysql_errno(g_SQL) == 0 && g_SQL){
		...
		print(" Filterscript version: 1.7");
...
CMD:viptoys(playerid){
    ...
    SendClientMessage(playerid, VIPCOLOR_WHITE, "* Coming soon!");
